...
<div className='w-full h-1/2  bg-slate-50 flex justify-center max-md:w-screen max-md:h-40 max-md:flex-col '>


   <form className=' mr-8 mt-2.5 max-md:absolute max-md:top-1  max-md:left-0 ' > 
...
<div className='mr-40'>
  <RiAccountPinBoxFill size={28} className=" mt-4  hover:scale-125 hover:text-slate-600 cursor-pointer max-md:absolute max-md:left-0 max-md:ml-0 
  max-md:mt-24 
  
  "/>
  <h3 className=" absolute top-4 ml-8 font-bold  max-md:left-0
  max-md:ml-8 max-md:mt-20
  "> Account</h3>
</div>

<div className="max-md:hidden  mr-40">
<IoMdHelpCircle size={28} className='  mt-4 hover:scale-125 hover:text-slate-600 cursor-pointer'/>
<h3 className="absolute top-4 ml-8 font-bold "> Help</h3>
</div>

<div className="max-md:mr-4 max-md:mt-16 ">

  <FaShoppingCart size={28} className='mr-2 mt-4  ml-2 hover:scale-125 hover:text-slate-600 cursor-pointer max-md:mt-16  max-md:ml-0'/>
  <h3 className="absolute top-4 ml-10 font-bold max-md:top-32  max-md:ml-8"> Cart</h3>
</div>
