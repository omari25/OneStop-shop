...
function Slider() {
    ...
    return (
        <div className="slider">
            <AiOutlineVerticalRight className="slide-icon-left" onClick={previousSlide}/>
            <AiOutlineVerticalLeft  className="slide-icon-right" onClick={nextSlide}/>
            {slideData.map((slide, index) => {
                return (
                    <div className={index === currentSlide ? "slide current" : "slide"} key={index}>
                        {index === currentSlide && (
                            <>
                                <img src={slide.img} alt="slide" className="w-full"/>
                            </>
                        )}
                    </div>
                )
